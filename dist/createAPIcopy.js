...
var timeStamp = Math.floor(Date.now()); // Place your API key and secret below. You can generate it from the website.
...
body = {
  "side": "buy",
  //Toggle between 'buy' or 'sell'.
  "order_type": "limit_order",
  //Toggle between a 'market_order' or 'limit_order'.
  "market": "TRXINR",
  //Replace 'SNTBTC' with your desired market pair.
  "price_per_unit": "9.69",
  //This parameter is only required for a 'limit_order'
  "total_quantity": 11,
...
//# sourceMappingURL=createAPIcopy.js.map